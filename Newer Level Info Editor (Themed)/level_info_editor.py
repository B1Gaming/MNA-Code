...
# Modded by RedStoneMatt to allow for compatibility with his preGame Color Changer mod
...
class LevelInfo():
    ...
    def setDisplayTheme(self, theme):
        """Sets the Display theme (theme number)"""
        ...
        for offset in worldOffs:
            ...
            for levelOff in range(int(len(worldData)/12)):
                ...
                if levelData[3] >= 100:
                    ...
                    level.setDisplayTheme(levelData[5])
    ...
    def save(self):
        ...
        for world in self.worlds:
            ...
            for level in world.Levels:
                ...
                worldData.append(level.DisplayTheme)
...
class LevelEditor(QtWidgets.QGroupBox):
    ...
    def __init__(self):
        ...
        self.ThemeEdit = QtWidgets.QSpinBox()
        self.ThemeEdit.setMaximum(65536)
        ...
        self.ThemeEdit.setToolTip('<b>Display Theme:</b><br>Changes the used theme in the preGame Layout.')
        ...
        self.ThemeEdit.setEnabled(False)
        ...
        self.ThemeEdit.valueChanged.connect(self.HandleThemeChange)
        ...
        L.addRow('Display Theme:', self.ThemeEdit)
    ...
    def setLevel(self, level):
        ...
        self.ThemeEdit.setEnabled(True)
        ...
        self.ThemeEdit.setValue(level.DisplayTheme)
    ...
    def HandleThemeChange(self):
        """Handles self.DisplayEdit changes"""
        if self.level == None: return
        self.level.DisplayTheme = self.ThemeEdit.value()
        self.dataChanged.emit()
