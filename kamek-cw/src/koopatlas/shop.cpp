...
void dWMShop_c::ShopModel_c::setupLakitu(int id) {
	static const char* models[8] = { 
		"g3d/yoshi.brres", "g3d/desert.brres", "g3d/cavern.brres", "g3d/sakura.brres", "g3d/snow.brres", 
		"g3d/mountain.brres", "g3d/sky.brres", "g3d/lava.brres"
	};
